                    ...
                    <main>
                        <section className='notification-section'>
                            <div className='choose-notification'>
                                ...
                                <button onClick={(e) => navView(e.target.className, '.notification-section button', '.notification-section section', 'notif-active','notif-container-active' )}
                                className='friend_request'>Friend Request <span className='friendNum'>{userData.friendRequest !== undefined ? userData.friendRequest.length > 0 ? userData.friendRequest.length : null : null}</span></button>
                            </div>
